...
public class Adapter_KapasitasParkir_Konsumen extends RecyclerView.Adapter<Adapter_KapasitasParkir_Konsumen.MyViewHolder>{
    public List<Model_Kendaraan> kendaraan = new ArrayList<>();
    private Context context;
    private Adapter_KapasitasParkir_Konsumen.RecyclerViewClickListener mListener;

    private List<Model_KendaraanMasuk> mListKendaraanMasuk = new ArrayList<>();
    Integer terisi=0;
    public Adapter_KapasitasParkir_Konsumen(List<Model_Kendaraan> kendaraan, Context context, Adapter_KapasitasParkir_Konsumen.RecyclerViewClickListener mListener) {
    ...
    @NonNull
    @Override
    public Adapter_KapasitasParkir_Konsumen.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View v = LayoutInflater.from(context).inflate(R.layout.activity_recycle_adapter_kapasitas_parkir, viewGroup, false);
        return new Adapter_KapasitasParkir_Konsumen.MyViewHolder(v, mListener);
    }

    @Override
    public void onBindViewHolder(@NonNull final Adapter_KapasitasParkir_Konsumen.MyViewHolder myViewHolder, int i) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView, Adapter_KapasitasParkir_Konsumen.RecyclerViewClickListener listener) {
            super(itemView);
