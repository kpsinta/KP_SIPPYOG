...
public class tampil_laporan_harian extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tampil_laporan_harian);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(tampil_laporan_harian.this, admin_main_menu.class);
            startActivity(i);
            return true;
        }
